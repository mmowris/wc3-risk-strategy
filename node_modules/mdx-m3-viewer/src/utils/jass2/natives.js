...
function ConvertAnimType(C, L) {
    const i = lauxlib_1.luaL_checkinteger(L, 1);
    lua_1.lua_pushlightuserdata(L, C.constantHandles.animTypes[i]);
    return 1;
}
/**
...
function ConvertSubAnimType(C, L) {
    const i = lauxlib_1.luaL_checkinteger(L, 1);
    lua_1.lua_pushlightuserdata(L, C.constantHandles.subAnimTypes[i]);
    return 1;
}
/**
...
function OrderId(C, L) {
    const orderIdString = lauxlib_1.luaL_checkstring(L, 1);
...
function OrderId2String(C, L) {
    const orderId = lauxlib_1.luaL_checkinteger(L, 1);
 ...
 */
function UnitId(C, L) {
    const unitIdString = lauxlib_1.luaL_checkstring(L, 1);
...
function UnitId2String(C, L) {
    const unitId = lauxlib_1.luaL_checkinteger(L, 1);
...
function AbilityId(C, L) {
    const abilityIdString = lauxlib_1.luaL_checkstring(L, 1);
...
function AbilityId2String(C, L) {
    const abilityId = lauxlib_1.luaL_checkinteger(L, 1);
...
function GetObjectName(C, L) {
    const objectId = lauxlib_1.luaL_checkinteger(L, 1);
...
function R2SW(C, L) {
    const r = lauxlib_1.luaL_checknumber(L, 1);
    const width = lauxlib_1.luaL_checkinteger(L, 2);
    const precision = lauxlib_1.luaL_checkinteger(L, 3);
 ...
 */
function S2I(C, L) {
    const s = lauxlib_1.luaL_checkstring(L, 1);
...
function GetHandleId(C, L) {
    const h = lua_1.lua_touserdata(L, 1);
...
function SubString(C, L) {
    const source = lauxlib_1.luaL_checkstring(L, 1);
    const start = lauxlib_1.luaL_checkinteger(L, 2);
    const end_ = lauxlib_1.luaL_checkinteger(L, 3);
...
function StringCase(C, L) {
    const source = lauxlib_1.luaL_checkstring(L, 1);
    const upper = lua_1.lua_toboolean(L, 2);
...
function SetMapName(C, L) {
    const name = lauxlib_1.luaL_checkstring(L, 1);
...
function SetMapDescription(C, L) {
    const description = lauxlib_1.luaL_checkstring(L, 1);
...
function SetTeams(C, L) {
    const teamcount = lauxlib_1.luaL_checkinteger(L, 1);
...
function SetPlayers(C, L) {
    const playercount = lauxlib_1.luaL_checkinteger(L, 1);
...
function DefineStartLocationLoc(C, L) {
    const whichStartLoc = lauxlib_1.luaL_checkinteger(L, 1);
    const whichLocation = lua_1.lua_touserdata(L, 2);
...
function SetStartLocPrioCount(C, L) {
    const whichStartLoc = lauxlib_1.luaL_checkinteger(L, 1);
    const prioSlotCount = lauxlib_1.luaL_checkinteger(L, 2);
...
function SetStartLocPrio(C, L) {
    const whichStartLoc = lauxlib_1.luaL_checkinteger(L, 1);
    const prioSlotIndex = lauxlib_1.luaL_checkinteger(L, 2);
    const otherStartLocIndex = lauxlib_1.luaL_checkinteger(L, 3);
    const priority = lua_1.lua_touserdata(L, 4);
...
function SetGameTypeSupported(C, L) {
    const whichGameType = lua_1.lua_touserdata(L, 1);
    const value = lua_1.lua_toboolean(L, 2);
...
function SetMapFlag(C, L) {
    const whichMapFlag = lua_1.lua_touserdata(L, 1);
    const value = lua_1.lua_toboolean(L, 2);
...
function SetGamePlacement(C, L) {
    const whichPlacementType = lua_1.lua_touserdata(L, 1);
...
function SetGameSpeed(C, L) {
    const whichspeed = lua_1.lua_touserdata(L, 1);
...
function SetGameDifficulty(C, L) {
    const whichdifficulty = lua_1.lua_touserdata(L, 1);
...
function SetResourceDensity(C, L) {
    const whichdensity = lua_1.lua_touserdata(L, 1);
...
function GetStartLocationX(C, L) {
    const whichStartLocation = lauxlib_1.luaL_checkinteger(L, 1);
...
function SetPlayerTeam(C, L) {
    const whichPlayer = lua_1.lua_touserdata(L, 1);
    const whichTeam = lauxlib_1.luaL_checkinteger(L, 2);
...
function SetPlayerColor(C, L) {
    const whichPlayer = lua_1.lua_touserdata(L, 1);
    const color = lua_1.lua_touserdata(L, 2);
...
function SetPlayerAlliance(C, L) {
    const sourcePlayer = lua_1.lua_touserdata(L, 1);
    const otherPlayer = lua_1.lua_touserdata(L, 2);
    const whichAllianceSetting = lua_1.lua_touserdata(L, 3);
    const value = lua_1.lua_toboolean(L, 4);
...
function SetPlayerTaxRate(C, L) {
    const sourcePlayer = lua_1.lua_touserdata(L, 1);
    const otherPlayer = lua_1.lua_touserdata(L, 2);
    const whichResource = lua_1.lua_touserdata(L, 3);
    const rate = lauxlib_1.luaL_checkinteger(L, 4);
...
function SetPlayerRacePreference(C, L) {
    const whichPlayer = lua_1.lua_touserdata(L, 1);
    const whichRacePreference = lua_1.lua_touserdata(L, 2);
...
function SetPlayerController(C, L) {
    const whichPlayer = lua_1.lua_touserdata(L, 1);
    const controlType = lua_1.lua_touserdata(L, 2);
...
function SetPlayerOnScoreScreen(C, L) {
    const whichPlayer = lua_1.lua_touserdata(L, 1);
    const flag = lua_1.lua_toboolean(L, 2);
...
function IsPlayerRacePrefSet(C, L) {
    const whichPlayer = lua_1.lua_touserdata(L, 1);
    const pref = lua_1.lua_touserdata(L, 2);
...
function DestroyTimer(C, L) {
    const whichTimer = lua_1.lua_touserdata(L, 1);
...
function TimerStart(C, L) {
    ...
    const periodic = lua_1.lua_toboolean(L, 3);
    const handlerFunc = lauxlib_1.luaL_ref(L, lua_1.LUA_REGISTRYINDEX);
...
function DestroyGroup(C, L) {
    const whichGroup = lua_1.lua_touserdata(L, 1);
...
function GroupAddUnit(C, L) {
    const whichGroup = lua_1.lua_touserdata(L, 1);
    const whichUnit = lua_1.lua_touserdata(L, 2);
...
function GroupEnumUnitsOfType(C, L) {
    const whichGroup = lua_1.lua_touserdata(L, 1);
    const unitname = lauxlib_1.luaL_checkstring(L, 2);
    const filter = lua_1.lua_touserdata(L, 3);
...
function GroupEnumUnitsOfPlayer(C, L) {
    const whichGroup = lua_1.lua_touserdata(L, 1);
    const whichPlayer = lua_1.lua_touserdata(L, 2);
    const filter = lua_1.lua_touserdata(L, 3);
...
function GroupEnumUnitsOfTypeCounted(C, L) {
    ...
    const unitname = lauxlib_1.luaL_checkstring(L, 2);
    const filter = lua_1.lua_touserdata(L, 3);
    const countLimit = lauxlib_1.luaL_checkinteger(L, 4);
...
function GroupEnumUnitsInRect(C, L) {
    const whichGroup = lua_1.lua_touserdata(L, 1);
    const r = lua_1.lua_touserdata(L, 2);
    const filter = lua_1.lua_touserdata(L, 3);
...
function GroupEnumUnitsInRange(C, L) {
    ...
    const x = lauxlib_1.luaL_checknumber(L, 2);
    const y = lauxlib_1.luaL_checknumber(L, 3);
    const radius = lauxlib_1.luaL_checknumber(L, 4);
    const filter = lua_1.lua_touserdata(L, 5);
...
function GroupEnumUnitsInRangeOfLoc(C, L) {
    const whichGroup = lua_1.lua_touserdata(L, 1);
    const whichLocation = lua_1.lua_touserdata(L, 2);
    const radius = lauxlib_1.luaL_checknumber(L, 3);
    const filter = lua_1.lua_touserdata(L, 4);
...
function GroupEnumUnitsInRangeCounted(C, L) {
    ...
    const radius = lauxlib_1.luaL_checknumber(L, 4);
    const filter = lua_1.lua_touserdata(L, 5);
    const countLimit = lauxlib_1.luaL_checkinteger(L, 6);
...
function GroupEnumUnitsInRangeOfLocCounted(C, L) {
    ...
    const radius = lauxlib_1.luaL_checknumber(L, 3);
    const filter = lua_1.lua_touserdata(L, 4);
    const countLimit = lauxlib_1.luaL_checkinteger(L, 5);
...
function GroupImmediateOrder(C, L) {
    const whichGroup = lua_1.lua_touserdata(L, 1);
    const order = lauxlib_1.luaL_checkstring(L, 2);
...
function GroupImmediateOrderById(C, L) {
    const whichGroup = lua_1.lua_touserdata(L, 1);
    const order = lauxlib_1.luaL_checkinteger(L, 2);
...
function GroupPointOrderLoc(C, L) {
    const whichGroup = lua_1.lua_touserdata(L, 1);
    const order = lauxlib_1.luaL_checkstring(L, 2);
    const whichLocation = lua_1.lua_touserdata(L, 3);
...
function GroupTargetOrder(C, L) {
    const whichGroup = lua_1.lua_touserdata(L, 1);
    const order = lauxlib_1.luaL_checkstring(L, 2);
    const targetWidget = lua_1.lua_touserdata(L, 3);
...
function ForGroup(C, L) {
    const whichGroup = lua_1.lua_touserdata(L, 1);
    const callback = lauxlib_1.luaL_ref(L, lua_1.LUA_REGISTRYINDEX);
...
function DestroyForce(C, L) {
    const whichForce = lua_1.lua_touserdata(L, 1);
...
function ForceEnumPlayers(C, L) {
    const whichForce = lua_1.lua_touserdata(L, 1);
    const filter = lua_1.lua_touserdata(L, 2);
...
function ForceEnumPlayersCounted(C, L) {
    const whichForce = lua_1.lua_touserdata(L, 1);
    const filter = lua_1.lua_touserdata(L, 2);
    const countLimit = lauxlib_1.luaL_checkinteger(L, 3);
 ...
 */
function Rect(C, L) {
    const minx = lauxlib_1.luaL_checknumber(L, 1);
    const miny = lauxlib_1.luaL_checknumber(L, 2);
    const maxx = lauxlib_1.luaL_checknumber(L, 3);
    const maxy = lauxlib_1.luaL_checknumber(L, 4);
...
function RectFromLoc(C, L) {
    const min = lua_1.lua_touserdata(L, 1);
    const max = lua_1.lua_touserdata(L, 2);
...
function RemoveRect(C, L) {
    const whichRect = lua_1.lua_touserdata(L, 1);
...
function SetRect(C, L) {
    const whichRect = lua_1.lua_touserdata(L, 1);
    const minx = lauxlib_1.luaL_checknumber(L, 2);
    const miny = lauxlib_1.luaL_checknumber(L, 3);
    const maxx = lauxlib_1.luaL_checknumber(L, 4);
    const maxy = lauxlib_1.luaL_checknumber(L, 5);
...
function SetRectFromLoc(C, L) {
    const whichRect = lua_1.lua_touserdata(L, 1);
    const min = lua_1.lua_touserdata(L, 2);
    const max = lua_1.lua_touserdata(L, 3);
...
function MoveRectTo(C, L) {
    const whichRect = lua_1.lua_touserdata(L, 1);
    const newCenterX = lauxlib_1.luaL_checknumber(L, 2);
    const newCenterY = lauxlib_1.luaL_checknumber(L, 3);
...
function MoveRectToLoc(C, L) {
    const whichRect = lua_1.lua_touserdata(L, 1);
    const newCenterLoc = lua_1.lua_touserdata(L, 2);
...
function RemoveRegion(C, L) {
    const whichRegion = lua_1.lua_touserdata(L, 1);
...
function Location(C, L) {
    const x = lauxlib_1.luaL_checknumber(L, 1);
    const y = lauxlib_1.luaL_checknumber(L, 2);
...
function RemoveLocation(C, L) {
    const whichLocation = lua_1.lua_touserdata(L, 1);
...
function MoveLocation(C, L) {
    const whichLocation = lua_1.lua_touserdata(L, 1);
    const newX = lauxlib_1.luaL_checknumber(L, 2);
    const newY = lauxlib_1.luaL_checknumber(L, 3);
...
function DestroyTrigger(C, L) {
    const whichTrigger = lua_1.lua_touserdata(L, 1);
...
function ExecuteFunc(C, L) {
    const funcName = lauxlib_1.luaL_checkstring(L, 1);
 ...
 */
function And(C, L) {
    const operandA = lua_1.lua_touserdata(L, 1);
    const operandB = lua_1.lua_touserdata(L, 2);
 ...
 */
function Not(C, L) {
    const operand = lua_1.lua_touserdata(L, 1);
...
function Condition(C, L) {
    const func = lauxlib_1.luaL_ref(L, lua_1.LUA_REGISTRYINDEX);
...
function DestroyCondition(C, L) {
    const c = lua_1.lua_touserdata(L, 1);
...
function DestroyFilter(C, L) {
    const f = lua_1.lua_touserdata(L, 1);
...
function DestroyBoolExpr(C, L) {
    const e = lua_1.lua_touserdata(L, 1);
...
function TriggerRegisterVariableEvent(C, L) {
    const whichTrigger = lua_1.lua_touserdata(L, 1);
    const varName = lauxlib_1.luaL_checkstring(L, 2);
    const opcode = lua_1.lua_touserdata(L, 3);
    const limitval = lauxlib_1.luaL_checknumber(L, 4);
...
function TriggerRegisterTimerExpireEvent(C, L) {
    const whichTrigger = lua_1.lua_touserdata(L, 1);
    const t = lua_1.lua_touserdata(L, 2);
...
function TriggerRegisterGameStateEvent(C, L) {
    const whichTrigger = lua_1.lua_touserdata(L, 1);
    const whichState = lua_1.lua_touserdata(L, 2);
    const opcode = lua_1.lua_touserdata(L, 3);
    const limitval = lauxlib_1.luaL_checknumber(L, 4);
...
function TriggerRegisterDialogEvent(C, L) {
    const whichTrigger = lua_1.lua_touserdata(L, 1);
    const whichDialog = lua_1.lua_touserdata(L, 2);
...
function TriggerRegisterDialogButtonEvent(C, L) {
    const whichTrigger = lua_1.lua_touserdata(L, 1);
    const whichButton = lua_1.lua_touserdata(L, 2);
...
function TriggerRegisterGameEvent(C, L) {
    const whichTrigger = lua_1.lua_touserdata(L, 1);
    const whichGameEvent = lua_1.lua_touserdata(L, 2);
...
function TriggerRegisterEnterRegion(C, L) {
    const whichTrigger = lua_1.lua_touserdata(L, 1);
    const whichRegion = lua_1.lua_touserdata(L, 2);
    const filter = lua_1.lua_touserdata(L, 3);
...
function TriggerRegisterPlayerEvent(C, L) {
    const whichTrigger = lua_1.lua_touserdata(L, 1);
    const whichPlayer = lua_1.lua_touserdata(L, 2);
    const whichPlayerEvent = lua_1.lua_touserdata(L, 3);
...
function TriggerRegisterPlayerUnitEvent(C, L) {
    const whichTrigger = lua_1.lua_touserdata(L, 1);
    const whichPlayer = lua_1.lua_touserdata(L, 2);
    const whichPlayerUnitEvent = lua_1.lua_touserdata(L, 3);
    const filter = lua_1.lua_touserdata(L, 4);
...
function TriggerRegisterPlayerAllianceChange(C, L) {
    const whichTrigger = lua_1.lua_touserdata(L, 1);
    const whichPlayer = lua_1.lua_touserdata(L, 2);
    const whichAlliance = lua_1.lua_touserdata(L, 3);
...
function TriggerRegisterPlayerStateEvent(C, L) {
    const whichTrigger = lua_1.lua_touserdata(L, 1);
    const whichPlayer = lua_1.lua_touserdata(L, 2);
    const whichState = lua_1.lua_touserdata(L, 3);
    const opcode = lua_1.lua_touserdata(L, 4);
    const limitval = lauxlib_1.luaL_checknumber(L, 5);
...
function TriggerRegisterPlayerChatEvent(C, L) {
    const whichTrigger = lua_1.lua_touserdata(L, 1);
    const whichPlayer = lua_1.lua_touserdata(L, 2);
    const chatMessageToDetect = lauxlib_1.luaL_checkstring(L, 3);
    const exactMatchOnly = lua_1.lua_toboolean(L, 4);
...
function TriggerRegisterDeathEvent(C, L) {
    const whichTrigger = lua_1.lua_touserdata(L, 1);
    const whichWidget = lua_1.lua_touserdata(L, 2);
...
function TriggerRegisterUnitEvent(C, L) {
    const whichTrigger = lua_1.lua_touserdata(L, 1);
    const whichUnit = lua_1.lua_touserdata(L, 2);
    const whichEvent = lua_1.lua_touserdata(L, 3);
...
function TriggerRegisterUnitInRange(C, L) {
    const whichTrigger = lua_1.lua_touserdata(L, 1);
    const whichUnit = lua_1.lua_touserdata(L, 2);
    const range = lauxlib_1.luaL_checknumber(L, 3);
    const filter = lua_1.lua_touserdata(L, 4);
...
function TriggerAddCondition(C, L) {
    const whichTrigger = lua_1.lua_touserdata(L, 1);
    const condition = lua_1.lua_touserdata(L, 2);
...
function TriggerRemoveCondition(C, L) {
    const whichTrigger = lua_1.lua_touserdata(L, 1);
    const whichCondition = lua_1.lua_touserdata(L, 2);
...
function TriggerAddAction(C, L) {
    const whichTrigger = lua_1.lua_touserdata(L, 1);
    const actionFunc = lauxlib_1.luaL_ref(L, lua_1.LUA_REGISTRYINDEX);
...
function TriggerRemoveAction(C, L) {
    const whichTrigger = lua_1.lua_touserdata(L, 1);
    const whichAction = lua_1.lua_touserdata(L, 2);
...
function TriggerWaitForSound(C, L) {
    const s = lua_1.lua_touserdata(L, 1);
    const offset = lauxlib_1.luaL_checknumber(L, 2);
...
function GetWidgetLife(C, L) {
    const whichWidget = lua_1.lua_touserdata(L, 1);
...
function SetWidgetLife(C, L) {
    const whichWidget = lua_1.lua_touserdata(L, 1);
    const newLife = lauxlib_1.luaL_checknumber(L, 2);
...
function CreateDestructable(C, L) {
    ...
    const x = lauxlib_1.luaL_checknumber(L, 2);
    const y = lauxlib_1.luaL_checknumber(L, 3);
    const face = lauxlib_1.luaL_checknumber(L, 4);
    const scale = lauxlib_1.luaL_checknumber(L, 5);
    const variation = lauxlib_1.luaL_checkinteger(L, 6);
...
function CreateDestructableZ(C, L) {
    ...
    const x = lauxlib_1.luaL_checknumber(L, 2);
    const y = lauxlib_1.luaL_checknumber(L, 3);
    const z = lauxlib_1.luaL_checknumber(L, 4);
    const face = lauxlib_1.luaL_checknumber(L, 5);
    const scale = lauxlib_1.luaL_checknumber(L, 6);
    const variation = lauxlib_1.luaL_checkinteger(L, 7);
...
function RemoveDestructable(C, L) {
    const d = lua_1.lua_touserdata(L, 1);
...
function EnumDestructablesInRect(C, L) {
    const r = lua_1.lua_touserdata(L, 1);
    const filter = lua_1.lua_touserdata(L, 2);
    const actionFunc = lauxlib_1.luaL_ref(L, lua_1.LUA_REGISTRYINDEX);
...
function SetDestructableLife(C, L) {
    const d = lua_1.lua_touserdata(L, 1);
    const life = lauxlib_1.luaL_checknumber(L, 2);
...
function SetDestructableMaxLife(C, L) {
    const d = lua_1.lua_touserdata(L, 1);
    const max = lauxlib_1.luaL_checknumber(L, 2);
...
function DestructableRestoreLife(C, L) {
    const d = lua_1.lua_touserdata(L, 1);
    const life = lauxlib_1.luaL_checknumber(L, 2);
    const birth = lua_1.lua_toboolean(L, 3);
...
function QueueDestructableAnimation(C, L) {
    const d = lua_1.lua_touserdata(L, 1);
    const whichAnimation = lauxlib_1.luaL_checkstring(L, 2);
...
function SetDestructableAnimationSpeed(C, L) {
    const d = lua_1.lua_touserdata(L, 1);
    const speedFactor = lauxlib_1.luaL_checknumber(L, 2);
...
function SetDestructableOccluderHeight(C, L) {
    const d = lua_1.lua_touserdata(L, 1);
    const height = lauxlib_1.luaL_checknumber(L, 2);
...
function CreateItem(C, L) {
    const itemid = lauxlib_1.luaL_checkinteger(L, 1);
    const x = lauxlib_1.luaL_checknumber(L, 2);
    const y = lauxlib_1.luaL_checknumber(L, 3);
...
function RemoveItem(C, L) {
    const whichItem = lua_1.lua_touserdata(L, 1);
...
function GetItemTypeId(C, L) {
    const i = lua_1.lua_touserdata(L, 1);
...
function SetItemPlayer(C, L) {
    const whichItem = lua_1.lua_touserdata(L, 1);
    const whichPlayer = lua_1.lua_touserdata(L, 2);
    const changeColor = lua_1.lua_toboolean(L, 3);
...
function SetItemVisible(C, L) {
    const whichItem = lua_1.lua_touserdata(L, 1);
    const show = lua_1.lua_toboolean(L, 2);
...
function SetItemCharges(C, L) {
    const whichItem = lua_1.lua_touserdata(L, 1);
    const charges = lauxlib_1.luaL_checkinteger(L, 2);
...
function SetItemUserData(C, L) {
    const whichItem = lua_1.lua_touserdata(L, 1);
    const data = lauxlib_1.luaL_checkinteger(L, 2);
...
function CreateUnit(C, L) {
    const id = lua_1.lua_touserdata(L, 1);
    const unitid = lauxlib_1.luaL_checkinteger(L, 2);
    const x = lauxlib_1.luaL_checknumber(L, 3);
    const y = lauxlib_1.luaL_checknumber(L, 4);
    const face = lauxlib_1.luaL_checknumber(L, 5);
...
function KillUnit(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
...
function SetUnitState(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const whichUnitState = lua_1.lua_touserdata(L, 2);
    const newVal = lauxlib_1.luaL_checknumber(L, 3);
...
function SetUnitY(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const newY = lauxlib_1.luaL_checknumber(L, 2);
...
function SetUnitFacing(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const facingAngle = lauxlib_1.luaL_checknumber(L, 2);
...
function SetUnitFacingTimed(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const facingAngle = lauxlib_1.luaL_checknumber(L, 2);
    const duration = lauxlib_1.luaL_checknumber(L, 3);
...
function SetUnitMoveSpeed(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const newSpeed = lauxlib_1.luaL_checknumber(L, 2);
...
function SetUnitFlyHeight(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const newHeight = lauxlib_1.luaL_checknumber(L, 2);
    const rate = lauxlib_1.luaL_checknumber(L, 3);
...
function SetUnitTurnSpeed(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const newTurnSpeed = lauxlib_1.luaL_checknumber(L, 2);
...
function SetUnitPropWindow(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const newPropWindowAngle = lauxlib_1.luaL_checknumber(L, 2);
...
function SetUnitAcquireRange(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const newAcquireRange = lauxlib_1.luaL_checknumber(L, 2);
...
function SetUnitCreepGuard(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const creepGuard = lua_1.lua_toboolean(L, 2);
...
function SetUnitColor(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const whichColor = lua_1.lua_touserdata(L, 2);
...
function SetUnitScale(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const scaleX = lauxlib_1.luaL_checknumber(L, 2);
    const scaleY = lauxlib_1.luaL_checknumber(L, 3);
    const scaleZ = lauxlib_1.luaL_checknumber(L, 4);
...
function SetUnitTimeScale(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const timeScale = lauxlib_1.luaL_checknumber(L, 2);
...
function SetUnitBlendTime(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const blendTime = lauxlib_1.luaL_checknumber(L, 2);
...
function SetUnitVertexColor(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const red = lauxlib_1.luaL_checkinteger(L, 2);
    const green = lauxlib_1.luaL_checkinteger(L, 3);
    const blue = lauxlib_1.luaL_checkinteger(L, 4);
    const alpha = lauxlib_1.luaL_checkinteger(L, 5);
...
function SetUnitAnimationByIndex(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const whichAnimation = lauxlib_1.luaL_checkinteger(L, 2);
...
function SetUnitAnimationWithRarity(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const whichAnimation = lauxlib_1.luaL_checkstring(L, 2);
    const rarity = lua_1.lua_touserdata(L, 3);
...
function AddUnitAnimationProperties(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const animProperties = lauxlib_1.luaL_checkstring(L, 2);
    const add = lua_1.lua_toboolean(L, 3);
...
function SetUnitLookAt(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const whichBone = lauxlib_1.luaL_checkstring(L, 2);
    const lookAtTarget = lua_1.lua_touserdata(L, 3);
    const offsetX = lauxlib_1.luaL_checknumber(L, 4);
    const offsetY = lauxlib_1.luaL_checknumber(L, 5);
    const offsetZ = lauxlib_1.luaL_checknumber(L, 6);
...
function SetUnitRescuable(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const byWhichPlayer = lua_1.lua_touserdata(L, 2);
    const flag = lua_1.lua_toboolean(L, 3);
...
function SetUnitRescueRange(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const range = lauxlib_1.luaL_checknumber(L, 2);
...
function SetHeroStr(C, L) {
    const whichHero = lua_1.lua_touserdata(L, 1);
    const newStr = lauxlib_1.luaL_checkinteger(L, 2);
    const permanent = lua_1.lua_toboolean(L, 3);
...
function SetHeroAgi(C, L) {
    const whichHero = lua_1.lua_touserdata(L, 1);
    const newAgi = lauxlib_1.luaL_checkinteger(L, 2);
    const permanent = lua_1.lua_toboolean(L, 3);
...
function SetHeroInt(C, L) {
    const whichHero = lua_1.lua_touserdata(L, 1);
    const newInt = lauxlib_1.luaL_checkinteger(L, 2);
    const permanent = lua_1.lua_toboolean(L, 3);
...
function GetHeroStr(C, L) {
    const whichHero = lua_1.lua_touserdata(L, 1);
    const includeBonuses = lua_1.lua_toboolean(L, 2);
...
function UnitStripHeroLevel(C, L) {
    const whichHero = lua_1.lua_touserdata(L, 1);
    const howManyLevels = lauxlib_1.luaL_checkinteger(L, 2);
...
function SetHeroXP(C, L) {
    const whichHero = lua_1.lua_touserdata(L, 1);
    const newXpVal = lauxlib_1.luaL_checkinteger(L, 2);
    const showEyeCandy = lua_1.lua_toboolean(L, 3);
...
function UnitModifySkillPoints(C, L) {
    const whichHero = lua_1.lua_touserdata(L, 1);
    const skillPointDelta = lauxlib_1.luaL_checkinteger(L, 2);
...
function AddHeroXP(C, L) {
    const whichHero = lua_1.lua_touserdata(L, 1);
    const xpToAdd = lauxlib_1.luaL_checkinteger(L, 2);
    const showEyeCandy = lua_1.lua_toboolean(L, 3);
...
function SetHeroLevel(C, L) {
    const whichHero = lua_1.lua_touserdata(L, 1);
    const level = lauxlib_1.luaL_checkinteger(L, 2);
    const showEyeCandy = lua_1.lua_toboolean(L, 3);
...
function SelectHeroSkill(C, L) {
    const whichHero = lua_1.lua_touserdata(L, 1);
    const abilcode = lauxlib_1.luaL_checkinteger(L, 2);
...
function SetUnitAbilityLevel(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const abilcode = lauxlib_1.luaL_checkinteger(L, 2);
    const level = lauxlib_1.luaL_checkinteger(L, 3);
...
function ReviveHero(C, L) {
    ...
    const x = lauxlib_1.luaL_checknumber(L, 2);
    const y = lauxlib_1.luaL_checknumber(L, 3);
    const doEyecandy = lua_1.lua_toboolean(L, 4);
...
function ReviveHeroLoc(C, L) {
    const whichHero = lua_1.lua_touserdata(L, 1);
    const loc = lua_1.lua_touserdata(L, 2);
    const doEyecandy = lua_1.lua_toboolean(L, 3);
...
function SetUnitExploded(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const exploded = lua_1.lua_toboolean(L, 2);
...
function GetUnitPointValueByType(C, L) {
    const unitType = lauxlib_1.luaL_checkinteger(L, 1);
...
function UnitAddItem(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const whichItem = lua_1.lua_touserdata(L, 2);
...
function UnitAddItemById(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const itemId = lauxlib_1.luaL_checkinteger(L, 2);
...
function UnitAddItemToSlotById(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const itemId = lauxlib_1.luaL_checkinteger(L, 2);
    const itemSlot = lauxlib_1.luaL_checkinteger(L, 3);
...
function UnitRemoveItemFromSlot(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const itemSlot = lauxlib_1.luaL_checkinteger(L, 2);
...
function UnitDropItemSlot(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const whichItem = lua_1.lua_touserdata(L, 2);
    const slot = lauxlib_1.luaL_checkinteger(L, 3);
...
function UnitDropItemTarget(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const whichItem = lua_1.lua_touserdata(L, 2);
    const target = lua_1.lua_touserdata(L, 3);
...
function SetUnitUseFood(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const useFood = lua_1.lua_toboolean(L, 2);
...
function IsUnitInGroup(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const whichGroup = lua_1.lua_touserdata(L, 2);
...
function IsUnitInForce(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const whichForce = lua_1.lua_touserdata(L, 2);
...
function IsUnitRace(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const whichRace = lua_1.lua_touserdata(L, 2);
...
function IsUnitType(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const whichUnitType = lua_1.lua_touserdata(L, 2);
...
function IsUnit(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const whichSpecifiedUnit = lua_1.lua_touserdata(L, 2);
...
function IsUnitInRange(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const otherUnit = lua_1.lua_touserdata(L, 2);
    const distance = lauxlib_1.luaL_checknumber(L, 3);
...
function IsUnitInRangeXY(C, L) {
    ...
    const x = lauxlib_1.luaL_checknumber(L, 2);
    const y = lauxlib_1.luaL_checknumber(L, 3);
    const distance = lauxlib_1.luaL_checknumber(L, 4);
...
function IsUnitInTransport(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const whichTransport = lua_1.lua_touserdata(L, 2);
...
function UnitShareVision(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const whichPlayer = lua_1.lua_touserdata(L, 2);
    const share = lua_1.lua_toboolean(L, 3);
...
function UnitSuspendDecay(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const suspend = lua_1.lua_toboolean(L, 2);
...
function UnitAddAbility(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const abilityId = lauxlib_1.luaL_checkinteger(L, 2);
...
function UnitMakeAbilityPermanent(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const permanent = lua_1.lua_toboolean(L, 2);
    const abilityId = lauxlib_1.luaL_checkinteger(L, 3);
...
function UnitRemoveBuffs(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const removePositive = lua_1.lua_toboolean(L, 2);
    const removeNegative = lua_1.lua_toboolean(L, 3);
...
function UnitRemoveBuffsEx(C, L) {
    ...
    const removePositive = lua_1.lua_toboolean(L, 2);
    const removeNegative = lua_1.lua_toboolean(L, 3);
    const magic = lua_1.lua_toboolean(L, 4);
    const physical = lua_1.lua_toboolean(L, 5);
    const timedLife = lua_1.lua_toboolean(L, 6);
    const aura = lua_1.lua_toboolean(L, 7);
    const autoDispel = lua_1.lua_toboolean(L, 8);
...
function UnitAddSleep(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const add = lua_1.lua_toboolean(L, 2);
...
function UnitApplyTimedLife(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const buffId = lauxlib_1.luaL_checkinteger(L, 2);
    const duration = lauxlib_1.luaL_checknumber(L, 3);
...
function UnitSetConstructionProgress(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const constructionPercentage = lauxlib_1.luaL_checkinteger(L, 2);
...
function UnitSetUpgradeProgress(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const upgradePercentage = lauxlib_1.luaL_checkinteger(L, 2);
...
function UnitDamagePoint(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const delay = lauxlib_1.luaL_checknumber(L, 2);
    const radius = lauxlib_1.luaL_checknumber(L, 3);
    const x = lauxlib_1.luaL_checknumber(L, 4);
    const y = lauxlib_1.luaL_checknumber(L, 5);
    const amount = lauxlib_1.luaL_checknumber(L, 6);
    const attack = lua_1.lua_toboolean(L, 7);
    const ranged = lua_1.lua_toboolean(L, 8);
    const attackType = lua_1.lua_touserdata(L, 9);
    const damageType = lua_1.lua_touserdata(L, 10);
    const weaponType = lua_1.lua_touserdata(L, 11);
...
function UnitDamageTarget(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const target = lua_1.lua_touserdata(L, 2);
    const amount = lauxlib_1.luaL_checknumber(L, 3);
    const attack = lua_1.lua_toboolean(L, 4);
    const ranged = lua_1.lua_toboolean(L, 5);
    const attackType = lua_1.lua_touserdata(L, 6);
    const damageType = lua_1.lua_touserdata(L, 7);
    const weaponType = lua_1.lua_touserdata(L, 8);
...
function IssueInstantPointOrder(C, L) {
    ...
    const x = lauxlib_1.luaL_checknumber(L, 3);
    const y = lauxlib_1.luaL_checknumber(L, 4);
    const instantTargetWidget = lua_1.lua_touserdata(L, 5);
...
function IssueInstantTargetOrder(C, L) {
    ...
    const order = lauxlib_1.luaL_checkstring(L, 2);
    const targetWidget = lua_1.lua_touserdata(L, 3);
    const instantTargetWidget = lua_1.lua_touserdata(L, 4);
...
function IssueBuildOrder(C, L) {
    const whichPeon = lua_1.lua_touserdata(L, 1);
    const unitToBuild = lauxlib_1.luaL_checkstring(L, 2);
    const x = lauxlib_1.luaL_checknumber(L, 3);
    const y = lauxlib_1.luaL_checknumber(L, 4);
...
function IssueNeutralImmediateOrder(C, L) {
    const forWhichPlayer = lua_1.lua_touserdata(L, 1);
    const neutralStructure = lua_1.lua_touserdata(L, 2);
    const unitToBuild = lauxlib_1.luaL_checkstring(L, 3);
...
function IssueNeutralImmediateOrderById(C, L) {
    const forWhichPlayer = lua_1.lua_touserdata(L, 1);
    const neutralStructure = lua_1.lua_touserdata(L, 2);
    const unitId = lauxlib_1.luaL_checkinteger(L, 3);
...
function IssueNeutralTargetOrder(C, L) {
    ...
    const neutralStructure = lua_1.lua_touserdata(L, 2);
    const unitToBuild = lauxlib_1.luaL_checkstring(L, 3);
    const target = lua_1.lua_touserdata(L, 4);
...
function SetResourceAmount(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const amount = lauxlib_1.luaL_checkinteger(L, 2);
...
function WaygateGetDestinationX(C, L) {
    const waygate = lua_1.lua_touserdata(L, 1);
...
function WaygateActivate(C, L) {
    const waygate = lua_1.lua_touserdata(L, 1);
    const activate = lua_1.lua_toboolean(L, 2);
...
function AddItemToAllStock(C, L) {
    const itemId = lauxlib_1.luaL_checkinteger(L, 1);
    const currentStock = lauxlib_1.luaL_checkinteger(L, 2);
    const stockMax = lauxlib_1.luaL_checkinteger(L, 3);
...
function AddItemToStock(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const itemId = lauxlib_1.luaL_checkinteger(L, 2);
    const currentStock = lauxlib_1.luaL_checkinteger(L, 3);
    const stockMax = lauxlib_1.luaL_checkinteger(L, 4);
...
function SetAllItemTypeSlots(C, L) {
    const slots = lauxlib_1.luaL_checkinteger(L, 1);
...
function SetItemTypeSlots(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const slots = lauxlib_1.luaL_checkinteger(L, 2);
...
function IsVisibleToPlayer(C, L) {
    const x = lauxlib_1.luaL_checknumber(L, 1);
    const y = lauxlib_1.luaL_checknumber(L, 2);
    const whichPlayer = lua_1.lua_touserdata(L, 3);
...
function GetPlayerUnitCount(C, L) {
    const whichPlayer = lua_1.lua_touserdata(L, 1);
    const includeIncomplete = lua_1.lua_toboolean(L, 2);
...
function GetPlayerTypedUnitCount(C, L) {
    const whichPlayer = lua_1.lua_touserdata(L, 1);
    const unitName = lauxlib_1.luaL_checkstring(L, 2);
    const includeIncomplete = lua_1.lua_toboolean(L, 3);
    const includeUpgrades = lua_1.lua_toboolean(L, 4);
...
function GetPlayerState(C, L) {
    const whichPlayer = lua_1.lua_touserdata(L, 1);
    const whichPlayerState = lua_1.lua_touserdata(L, 2);
...
function GetPlayerScore(C, L) {
    const whichPlayer = lua_1.lua_touserdata(L, 1);
    const whichPlayerScore = lua_1.lua_touserdata(L, 2);
...
function SetPlayerHandicap(C, L) {
    const whichPlayer = lua_1.lua_touserdata(L, 1);
    const handicap = lauxlib_1.luaL_checknumber(L, 2);
...
function SetPlayerTechMaxAllowed(C, L) {
    const whichPlayer = lua_1.lua_touserdata(L, 1);
    const techid = lauxlib_1.luaL_checkinteger(L, 2);
    const maximum = lauxlib_1.luaL_checkinteger(L, 3);
...
function AddPlayerTechResearched(C, L) {
    const whichPlayer = lua_1.lua_touserdata(L, 1);
    const techid = lauxlib_1.luaL_checkinteger(L, 2);
    const levels = lauxlib_1.luaL_checkinteger(L, 3);
...
function SetPlayerTechResearched(C, L) {
    const whichPlayer = lua_1.lua_touserdata(L, 1);
    const techid = lauxlib_1.luaL_checkinteger(L, 2);
    const setToLevel = lauxlib_1.luaL_checkinteger(L, 3);
...
function GetPlayerTechResearched(C, L) {
    const whichPlayer = lua_1.lua_touserdata(L, 1);
    const techid = lauxlib_1.luaL_checkinteger(L, 2);
    const specificonly = lua_1.lua_toboolean(L, 3);
...
function SetPlayerUnitsOwner(C, L) {
    const whichPlayer = lua_1.lua_touserdata(L, 1);
    const newOwner = lauxlib_1.luaL_checkinteger(L, 2);
...
function CripplePlayer(C, L) {
    const whichPlayer = lua_1.lua_touserdata(L, 1);
    const toWhichPlayers = lua_1.lua_touserdata(L, 2);
    const flag = lua_1.lua_toboolean(L, 3);
...
function SetPlayerAbilityAvailable(C, L) {
    const whichPlayer = lua_1.lua_touserdata(L, 1);
    const abilid = lauxlib_1.luaL_checkinteger(L, 2);
    const avail = lua_1.lua_toboolean(L, 3);
...
function SetPlayerState(C, L) {
    const whichPlayer = lua_1.lua_touserdata(L, 1);
    const whichPlayerState = lua_1.lua_touserdata(L, 2);
    const value = lauxlib_1.luaL_checkinteger(L, 3);
...
function RemovePlayer(C, L) {
    const whichPlayer = lua_1.lua_touserdata(L, 1);
    const gameResult = lua_1.lua_touserdata(L, 2);
...
function SetFogStateRect(C, L) {
    const forWhichPlayer = lua_1.lua_touserdata(L, 1);
    const whichState = lua_1.lua_touserdata(L, 2);
    const where = lua_1.lua_touserdata(L, 3);
    const useSharedVision = lua_1.lua_toboolean(L, 4);
...
function SetFogStateRadius(C, L) {
    const forWhichPlayer = lua_1.lua_touserdata(L, 1);
    const whichState = lua_1.lua_touserdata(L, 2);
    const centerx = lauxlib_1.luaL_checknumber(L, 3);
    const centerY = lauxlib_1.luaL_checknumber(L, 4);
    const radius = lauxlib_1.luaL_checknumber(L, 5);
    const useSharedVision = lua_1.lua_toboolean(L, 6);
...
function SetFogStateRadiusLoc(C, L) {
    const forWhichPlayer = lua_1.lua_touserdata(L, 1);
    const whichState = lua_1.lua_touserdata(L, 2);
    const center = lua_1.lua_touserdata(L, 3);
    const radius = lauxlib_1.luaL_checknumber(L, 4);
    const useSharedVision = lua_1.lua_toboolean(L, 5);
...
function FogMaskEnable(C, L) {
    const enable = lua_1.lua_toboolean(L, 1);
...
function CreateFogModifierRect(C, L) {
    ...
    const where = lua_1.lua_touserdata(L, 3);
    const useSharedVision = lua_1.lua_toboolean(L, 4);
    const afterUnits = lua_1.lua_toboolean(L, 5);
...
function CreateFogModifierRadius(C, L) {
    ...
    const radius = lauxlib_1.luaL_checknumber(L, 5);
    const useSharedVision = lua_1.lua_toboolean(L, 6);
    const afterUnits = lua_1.lua_toboolean(L, 7);
...
function CreateFogModifierRadiusLoc(C, L) {
    ...
    const radius = lauxlib_1.luaL_checknumber(L, 4);
    const useSharedVision = lua_1.lua_toboolean(L, 5);
    const afterUnits = lua_1.lua_toboolean(L, 6);
...
function DestroyFogModifier(C, L) {
    const whichFogModifier = lua_1.lua_touserdata(L, 1);
...
function VersionCompatible(C, L) {
    const whichVersion = lua_1.lua_touserdata(L, 1);
...
function EndGame(C, L) {
    const doScoreScreen = lua_1.lua_toboolean(L, 1);
...
function ChangeLevel(C, L) {
    const newLevel = lauxlib_1.luaL_checkstring(L, 1);
    const doScoreScreen = lua_1.lua_toboolean(L, 2);
...
function SetCampaignMenuRaceEx(C, L) {
    const campaignIndex = lauxlib_1.luaL_checkinteger(L, 1);
...
function LoadGame(C, L) {
    const saveFileName = lauxlib_1.luaL_checkstring(L, 1);
    const doScoreScreen = lua_1.lua_toboolean(L, 2);
...
function RenameSaveDirectory(C, L) {
    const sourceDirName = lauxlib_1.luaL_checkstring(L, 1);
    const destDirName = lauxlib_1.luaL_checkstring(L, 2);
...
function CopySaveGame(C, L) {
    const sourceSaveName = lauxlib_1.luaL_checkstring(L, 1);
    const destSaveName = lauxlib_1.luaL_checkstring(L, 2);
...
function SaveGameExists(C, L) {
    const saveName = lauxlib_1.luaL_checkstring(L, 1);
...
function SetFloatGameState(C, L) {
    const whichFloatGameState = lua_1.lua_touserdata(L, 1);
    const value = lauxlib_1.luaL_checknumber(L, 2);
...
function SetIntegerGameState(C, L) {
    const whichIntegerGameState = lua_1.lua_touserdata(L, 1);
    const value = lauxlib_1.luaL_checkinteger(L, 2);
...
function SetTutorialCleared(C, L) {
    const cleared = lua_1.lua_toboolean(L, 1);
...
function SetMissionAvailable(C, L) {
    const campaignNumber = lauxlib_1.luaL_checkinteger(L, 1);
    const missionNumber = lauxlib_1.luaL_checkinteger(L, 2);
    const available = lua_1.lua_toboolean(L, 3);
...
function SetCampaignAvailable(C, L) {
    const campaignNumber = lauxlib_1.luaL_checkinteger(L, 1);
    const available = lua_1.lua_toboolean(L, 2);
...
function SetDefaultDifficulty(C, L) {
    const g = lua_1.lua_touserdata(L, 1);
...
function SetCustomCampaignButtonVisible(C, L) {
    const whichButton = lauxlib_1.luaL_checkinteger(L, 1);
    const visible = lua_1.lua_toboolean(L, 2);
...
function DialogDestroy(C, L) {
    const whichDialog = lua_1.lua_touserdata(L, 1);
...
function DialogSetMessage(C, L) {
    const whichDialog = lua_1.lua_touserdata(L, 1);
    const messageText = lauxlib_1.luaL_checkstring(L, 2);
...
function DialogAddButton(C, L) {
    const whichDialog = lua_1.lua_touserdata(L, 1);
    const buttonText = lauxlib_1.luaL_checkstring(L, 2);
    const hotkey = lauxlib_1.luaL_checkinteger(L, 3);
...
function DialogAddQuitButton(C, L) {
    const whichDialog = lua_1.lua_touserdata(L, 1);
    const doScoreScreen = lua_1.lua_toboolean(L, 2);
    const buttonText = lauxlib_1.luaL_checkstring(L, 3);
    const hotkey = lauxlib_1.luaL_checkinteger(L, 4);
...
function InitGameCache(C, L) {
    const campaignFile = lauxlib_1.luaL_checkstring(L, 1);
...
function SaveGameCache(C, L) {
    const whichCache = lua_1.lua_touserdata(L, 1);
...
function StoreInteger(C, L) {
    const cache = lua_1.lua_touserdata(L, 1);
    const missionKey = lauxlib_1.luaL_checkstring(L, 2);
    const key = lauxlib_1.luaL_checkstring(L, 3);
    const value = lauxlib_1.luaL_checkinteger(L, 4);
...
function StoreReal(C, L) {
    ...
    const missionKey = lauxlib_1.luaL_checkstring(L, 2);
    const key = lauxlib_1.luaL_checkstring(L, 3);
    const value = lauxlib_1.luaL_checknumber(L, 4);
...
function StoreUnit(C, L) {
    ...
    const missionKey = lauxlib_1.luaL_checkstring(L, 2);
    const key = lauxlib_1.luaL_checkstring(L, 3);
    const whichUnit = lua_1.lua_touserdata(L, 4);
...
function StoreString(C, L) {
    ...
    const missionKey = lauxlib_1.luaL_checkstring(L, 2);
    const key = lauxlib_1.luaL_checkstring(L, 3);
    const value = lauxlib_1.luaL_checkstring(L, 4);
...
function RestoreUnit(C, L) {
    ...
    const missionKey = lauxlib_1.luaL_checkstring(L, 2);
    const key = lauxlib_1.luaL_checkstring(L, 3);
    const forWhichPlayer = lua_1.lua_touserdata(L, 4);
    const x = lauxlib_1.luaL_checknumber(L, 5);
    const y = lauxlib_1.luaL_checknumber(L, 6);
    const facing = lauxlib_1.luaL_checknumber(L, 7);
...
function SaveInteger(C, L) {
    const table = lua_1.lua_touserdata(L, 1);
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const value = lauxlib_1.luaL_checkinteger(L, 4);
...
function SavePlayerHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichPlayer = lua_1.lua_touserdata(L, 4);
...
function SaveWidgetHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichWidget = lua_1.lua_touserdata(L, 4);
...
function SaveDestructableHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichDestructable = lua_1.lua_touserdata(L, 4);
...
function SaveItemHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichItem = lua_1.lua_touserdata(L, 4);
...
function SaveAbilityHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichAbility = lua_1.lua_touserdata(L, 4);
...
function SaveTimerHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichTimer = lua_1.lua_touserdata(L, 4);
...
function SaveTriggerHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichTrigger = lua_1.lua_touserdata(L, 4);
...
function SaveTriggerConditionHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichTriggercondition = lua_1.lua_touserdata(L, 4);
...
function SaveTriggerActionHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichTriggeraction = lua_1.lua_touserdata(L, 4);
...
function SaveTriggerEventHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichEvent = lua_1.lua_touserdata(L, 4);
...
function SaveForceHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichForce = lua_1.lua_touserdata(L, 4);
...
function SaveGroupHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichGroup = lua_1.lua_touserdata(L, 4);
...
function SaveLocationHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichLocation = lua_1.lua_touserdata(L, 4);
...
function SaveRectHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichRect = lua_1.lua_touserdata(L, 4);
...
function SaveBooleanExprHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichBoolexpr = lua_1.lua_touserdata(L, 4);
...
function SaveSoundHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichSound = lua_1.lua_touserdata(L, 4);
...
function SaveEffectHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichEffect = lua_1.lua_touserdata(L, 4);
...
function SaveUnitPoolHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichUnitpool = lua_1.lua_touserdata(L, 4);
...
function SaveItemPoolHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichItempool = lua_1.lua_touserdata(L, 4);
...
function SaveQuestHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichQuest = lua_1.lua_touserdata(L, 4);
...
function SaveQuestItemHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichQuestitem = lua_1.lua_touserdata(L, 4);
...
function SaveDefeatConditionHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichDefeatcondition = lua_1.lua_touserdata(L, 4);
...
function SaveTimerDialogHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichTimerdialog = lua_1.lua_touserdata(L, 4);
...
function SaveLeaderboardHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichLeaderboard = lua_1.lua_touserdata(L, 4);
...
function SaveMultiboardHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichMultiboard = lua_1.lua_touserdata(L, 4);
...
function SaveMultiboardItemHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichMultiboarditem = lua_1.lua_touserdata(L, 4);
...
function SaveTrackableHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichTrackable = lua_1.lua_touserdata(L, 4);
...
function SaveDialogHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichDialog = lua_1.lua_touserdata(L, 4);
...
function SaveButtonHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichButton = lua_1.lua_touserdata(L, 4);
...
function SaveTextTagHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichTexttag = lua_1.lua_touserdata(L, 4);
...
function SaveLightningHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichLightning = lua_1.lua_touserdata(L, 4);
...
function SaveImageHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichImage = lua_1.lua_touserdata(L, 4);
...
function SaveUbersplatHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichUbersplat = lua_1.lua_touserdata(L, 4);
...
function SaveRegionHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichRegion = lua_1.lua_touserdata(L, 4);
...
function SaveFogStateHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichFogState = lua_1.lua_touserdata(L, 4);
...
function SaveFogModifierHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichFogModifier = lua_1.lua_touserdata(L, 4);
...
function SaveAgentHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichAgent = lua_1.lua_touserdata(L, 4);
...
function SaveHashtableHandle(C, L) {
    ...
    const parentKey = lauxlib_1.luaL_checkinteger(L, 2);
    const childKey = lauxlib_1.luaL_checkinteger(L, 3);
    const whichHashtable = lua_1.lua_touserdata(L, 4);
...
function GetRandomInt(C, L) {
    const lowBound = lauxlib_1.luaL_checkinteger(L, 1);
    const highBound = lauxlib_1.luaL_checkinteger(L, 2);
...
function GetRandomReal(C, L) {
    const lowBound = lauxlib_1.luaL_checknumber(L, 1);
    const highBound = lauxlib_1.luaL_checknumber(L, 2);
...
function DestroyUnitPool(C, L) {
    const whichPool = lua_1.lua_touserdata(L, 1);
...
function UnitPoolAddUnitType(C, L) {
    const whichPool = lua_1.lua_touserdata(L, 1);
    const unitId = lauxlib_1.luaL_checkinteger(L, 2);
    const weight = lauxlib_1.luaL_checknumber(L, 3);
...
function PlaceRandomUnit(C, L) {
    const whichPool = lua_1.lua_touserdata(L, 1);
    const forWhichPlayer = lua_1.lua_touserdata(L, 2);
    const x = lauxlib_1.luaL_checknumber(L, 3);
    const y = lauxlib_1.luaL_checknumber(L, 4);
    const facing = lauxlib_1.luaL_checknumber(L, 5);
...
function DestroyItemPool(C, L) {
    const whichItemPool = lua_1.lua_touserdata(L, 1);
...
function ChooseRandomCreep(C, L) {
    const level = lauxlib_1.luaL_checkinteger(L, 1);
...
function ChooseRandomItemEx(C, L) {
    const whichType = lua_1.lua_touserdata(L, 1);
    const level = lauxlib_1.luaL_checkinteger(L, 2);
...
function SetRandomSeed(C, L) {
    const seed = lauxlib_1.luaL_checkinteger(L, 1);
...
function SetTerrainFog(C, L) {
    const a = lauxlib_1.luaL_checknumber(L, 1);
    const b = lauxlib_1.luaL_checknumber(L, 2);
    const c = lauxlib_1.luaL_checknumber(L, 3);
    const d = lauxlib_1.luaL_checknumber(L, 4);
    const e = lauxlib_1.luaL_checknumber(L, 5);
...
function SetTerrainFogEx(C, L) {
    const style = lauxlib_1.luaL_checkinteger(L, 1);
    const zstart = lauxlib_1.luaL_checknumber(L, 2);
    const zend = lauxlib_1.luaL_checknumber(L, 3);
    const density = lauxlib_1.luaL_checknumber(L, 4);
    const red = lauxlib_1.luaL_checknumber(L, 5);
    const green = lauxlib_1.luaL_checknumber(L, 6);
    const blue = lauxlib_1.luaL_checknumber(L, 7);
...
function DisplayTextToPlayer(C, L) {
    const toPlayer = lua_1.lua_touserdata(L, 1);
    const x = lauxlib_1.luaL_checknumber(L, 2);
    const y = lauxlib_1.luaL_checknumber(L, 3);
    const message = lauxlib_1.luaL_checkstring(L, 4);
...
function DisplayTimedTextToPlayer(C, L) {
    ...
    const x = lauxlib_1.luaL_checknumber(L, 2);
    const y = lauxlib_1.luaL_checknumber(L, 3);
    const duration = lauxlib_1.luaL_checknumber(L, 4);
    const message = lauxlib_1.luaL_checkstring(L, 5);
...
function SetDayNightModels(C, L) {
    const terrainDNCFile = lauxlib_1.luaL_checkstring(L, 1);
    const unitDNCFile = lauxlib_1.luaL_checkstring(L, 2);
...
function SetSkyModel(C, L) {
    const skyModelFile = lauxlib_1.luaL_checkstring(L, 1);
...
function EnableUserControl(C, L) {
    const b = lua_1.lua_toboolean(L, 1);
...
function ShowInterface(C, L) {
    const flag = lua_1.lua_toboolean(L, 1);
    const fadeDuration = lauxlib_1.luaL_checknumber(L, 2);
...
function PingMinimapEx(C, L) {
    ...
    const y = lauxlib_1.luaL_checknumber(L, 2);
    const duration = lauxlib_1.luaL_checknumber(L, 3);
    const red = lauxlib_1.luaL_checkinteger(L, 4);
    const green = lauxlib_1.luaL_checkinteger(L, 5);
    const blue = lauxlib_1.luaL_checkinteger(L, 6);
    const extraEffects = lua_1.lua_toboolean(L, 7);
...
function SetIntroShotText(C, L) {
    const introText = lauxlib_1.luaL_checkstring(L, 1);
...
function SetIntroShotModel(C, L) {
    const introModelPath = lauxlib_1.luaL_checkstring(L, 1);
...
function PlayModelCinematic(C, L) {
    const modelName = lauxlib_1.luaL_checkstring(L, 1);
...
function PlayCinematic(C, L) {
    const movieName = lauxlib_1.luaL_checkstring(L, 1);
...
function ForceUIKey(C, L) {
    const key = lauxlib_1.luaL_checkstring(L, 1);
...
function SetAltMinimapIcon(C, L) {
    const iconPath = lauxlib_1.luaL_checkstring(L, 1);
...
function DestroyTextTag(C, L) {
    const t = lua_1.lua_touserdata(L, 1);
...
function SetTextTagText(C, L) {
    const t = lua_1.lua_touserdata(L, 1);
    const s = lauxlib_1.luaL_checkstring(L, 2);
    const height = lauxlib_1.luaL_checknumber(L, 3);
...
function SetTextTagPos(C, L) {
    ...
    const x = lauxlib_1.luaL_checknumber(L, 2);
    const y = lauxlib_1.luaL_checknumber(L, 3);
    const heightOffset = lauxlib_1.luaL_checknumber(L, 4);
...
function SetTextTagPosUnit(C, L) {
    const t = lua_1.lua_touserdata(L, 1);
    const whichUnit = lua_1.lua_touserdata(L, 2);
    const heightOffset = lauxlib_1.luaL_checknumber(L, 3);
...
function SetTextTagVelocity(C, L) {
    const t = lua_1.lua_touserdata(L, 1);
    const xvel = lauxlib_1.luaL_checknumber(L, 2);
    const yvel = lauxlib_1.luaL_checknumber(L, 3);
...
function SetTextTagAge(C, L) {
    const t = lua_1.lua_touserdata(L, 1);
    const age = lauxlib_1.luaL_checknumber(L, 2);
...
function SetTextTagLifespan(C, L) {
    const t = lua_1.lua_touserdata(L, 1);
    const lifespan = lauxlib_1.luaL_checknumber(L, 2);
...
function SetTextTagFadepoint(C, L) {
    const t = lua_1.lua_touserdata(L, 1);
    const fadepoint = lauxlib_1.luaL_checknumber(L, 2);
...
function SetReservedLocalHeroButtons(C, L) {
    const reserved = lauxlib_1.luaL_checkinteger(L, 1);
...
function SetAllyColorFilterState(C, L) {
    const state = lauxlib_1.luaL_checkinteger(L, 1);
...
function SetCreepCampFilterState(C, L) {
    const state = lua_1.lua_toboolean(L, 1);
...
function EnableMinimapFilterButtons(C, L) {
    const enableAlly = lua_1.lua_toboolean(L, 1);
    const enableCreep = lua_1.lua_toboolean(L, 2);
...
function EnableDragSelect(C, L) {
    const state = lua_1.lua_toboolean(L, 1);
    const ui = lua_1.lua_toboolean(L, 2);
...
function CreateTrackable(C, L) {
    const trackableModelPath = lauxlib_1.luaL_checkstring(L, 1);
    const x = lauxlib_1.luaL_checknumber(L, 2);
    const y = lauxlib_1.luaL_checknumber(L, 3);
    const facing = lauxlib_1.luaL_checknumber(L, 4);
...
function DestroyQuest(C, L) {
    const whichQuest = lua_1.lua_touserdata(L, 1);
...
function QuestSetTitle(C, L) {
    const whichQuest = lua_1.lua_touserdata(L, 1);
    const title = lauxlib_1.luaL_checkstring(L, 2);
...
function QuestSetDescription(C, L) {
    const whichQuest = lua_1.lua_touserdata(L, 1);
    const description = lauxlib_1.luaL_checkstring(L, 2);
...
function QuestSetIconPath(C, L) {
    const whichQuest = lua_1.lua_touserdata(L, 1);
    const iconPath = lauxlib_1.luaL_checkstring(L, 2);
...
function QuestSetRequired(C, L) {
    const whichQuest = lua_1.lua_touserdata(L, 1);
    const required = lua_1.lua_toboolean(L, 2);
...
function QuestSetCompleted(C, L) {
    const whichQuest = lua_1.lua_touserdata(L, 1);
    const completed = lua_1.lua_toboolean(L, 2);
...
function QuestSetDiscovered(C, L) {
    const whichQuest = lua_1.lua_touserdata(L, 1);
    const discovered = lua_1.lua_toboolean(L, 2);
...
function QuestSetFailed(C, L) {
    const whichQuest = lua_1.lua_touserdata(L, 1);
    const failed = lua_1.lua_toboolean(L, 2);
...
function QuestSetEnabled(C, L) {
    const whichQuest = lua_1.lua_touserdata(L, 1);
    const enabled = lua_1.lua_toboolean(L, 2);
...
function QuestItemSetDescription(C, L) {
    const whichQuestItem = lua_1.lua_touserdata(L, 1);
    const description = lauxlib_1.luaL_checkstring(L, 2);
...
function DestroyDefeatCondition(C, L) {
    const whichCondition = lua_1.lua_touserdata(L, 1);
...
function TimerDialogSetSpeed(C, L) {
    const whichDialog = lua_1.lua_touserdata(L, 1);
    const speedMultFactor = lauxlib_1.luaL_checknumber(L, 2);
...
function TimerDialogDisplay(C, L) {
    const whichDialog = lua_1.lua_touserdata(L, 1);
    const display = lua_1.lua_toboolean(L, 2);
...
function TimerDialogSetRealTimeRemaining(C, L) {
    const whichDialog = lua_1.lua_touserdata(L, 1);
    const timeRemaining = lauxlib_1.luaL_checknumber(L, 2);
...
function DestroyLeaderboard(C, L) {
    const lb = lua_1.lua_touserdata(L, 1);
...
function LeaderboardSetSizeByItemCount(C, L) {
    const lb = lua_1.lua_touserdata(L, 1);
    const count = lauxlib_1.luaL_checkinteger(L, 2);
...
function LeaderboardAddItem(C, L) {
    const lb = lua_1.lua_touserdata(L, 1);
    const label = lauxlib_1.luaL_checkstring(L, 2);
    const value = lauxlib_1.luaL_checkinteger(L, 3);
    const p = lua_1.lua_touserdata(L, 4);
...
function LeaderboardRemoveItem(C, L) {
    const lb = lua_1.lua_touserdata(L, 1);
    const index = lauxlib_1.luaL_checkinteger(L, 2);
...
function LeaderboardRemovePlayerItem(C, L) {
    const lb = lua_1.lua_touserdata(L, 1);
    const p = lua_1.lua_touserdata(L, 2);
...
function LeaderboardSortItemsByValue(C, L) {
    const lb = lua_1.lua_touserdata(L, 1);
    const ascending = lua_1.lua_toboolean(L, 2);
...
function PlayerSetLeaderboard(C, L) {
    const toPlayer = lua_1.lua_touserdata(L, 1);
    const lb = lua_1.lua_touserdata(L, 2);
...
function LeaderboardSetStyle(C, L) {
    const lb = lua_1.lua_touserdata(L, 1);
    const showLabel = lua_1.lua_toboolean(L, 2);
    const showNames = lua_1.lua_toboolean(L, 3);
    const showValues = lua_1.lua_toboolean(L, 4);
    const showIcons = lua_1.lua_toboolean(L, 5);
...
function LeaderboardSetItemValue(C, L) {
    const lb = lua_1.lua_touserdata(L, 1);
    const whichItem = lauxlib_1.luaL_checkinteger(L, 2);
    const val = lauxlib_1.luaL_checkinteger(L, 3);
...
function LeaderboardSetItemLabel(C, L) {
    const lb = lua_1.lua_touserdata(L, 1);
    const whichItem = lauxlib_1.luaL_checkinteger(L, 2);
    const val = lauxlib_1.luaL_checkstring(L, 3);
...
function LeaderboardSetItemStyle(C, L) {
    const lb = lua_1.lua_touserdata(L, 1);
    const whichItem = lauxlib_1.luaL_checkinteger(L, 2);
    const showLabel = lua_1.lua_toboolean(L, 3);
    const showValue = lua_1.lua_toboolean(L, 4);
    const showIcon = lua_1.lua_toboolean(L, 5);
...
function LeaderboardSetItemLabelColor(C, L) {
    const lb = lua_1.lua_touserdata(L, 1);
    const whichItem = lauxlib_1.luaL_checkinteger(L, 2);
    const red = lauxlib_1.luaL_checkinteger(L, 3);
    const green = lauxlib_1.luaL_checkinteger(L, 4);
    const blue = lauxlib_1.luaL_checkinteger(L, 5);
    const alpha = lauxlib_1.luaL_checkinteger(L, 6);
...
function MultiboardMinimize(C, L) {
    const lb = lua_1.lua_touserdata(L, 1);
    const minimize = lua_1.lua_toboolean(L, 2);
...
function MultiboardSetItemsStyle(C, L) {
    const lb = lua_1.lua_touserdata(L, 1);
    const showValues = lua_1.lua_toboolean(L, 2);
    const showIcons = lua_1.lua_toboolean(L, 3);
...
function MultiboardSetItemsValue(C, L) {
    const lb = lua_1.lua_touserdata(L, 1);
    const value = lauxlib_1.luaL_checkstring(L, 2);
...
function MultiboardSetItemsWidth(C, L) {
    const lb = lua_1.lua_touserdata(L, 1);
    const width = lauxlib_1.luaL_checknumber(L, 2);
...
function MultiboardGetItem(C, L) {
    const lb = lua_1.lua_touserdata(L, 1);
    const row = lauxlib_1.luaL_checkinteger(L, 2);
    const column = lauxlib_1.luaL_checkinteger(L, 3);
...
function MultiboardReleaseItem(C, L) {
    const mbi = lua_1.lua_touserdata(L, 1);
...
function MultiboardSetItemStyle(C, L) {
    const mbi = lua_1.lua_touserdata(L, 1);
    const showValue = lua_1.lua_toboolean(L, 2);
    const showIcon = lua_1.lua_toboolean(L, 3);
...
function MultiboardSetItemValue(C, L) {
    const mbi = lua_1.lua_touserdata(L, 1);
    const val = lauxlib_1.luaL_checkstring(L, 2);
...
function MultiboardSetItemIcon(C, L) {
    const mbi = lua_1.lua_touserdata(L, 1);
    const iconFileName = lauxlib_1.luaL_checkstring(L, 2);
...
function SetCameraBounds(C, L) {
    const x1 = lauxlib_1.luaL_checknumber(L, 1);
    const y1 = lauxlib_1.luaL_checknumber(L, 2);
    const x2 = lauxlib_1.luaL_checknumber(L, 3);
    const y2 = lauxlib_1.luaL_checknumber(L, 4);
    const x3 = lauxlib_1.luaL_checknumber(L, 5);
    const y3 = lauxlib_1.luaL_checknumber(L, 6);
    const x4 = lauxlib_1.luaL_checknumber(L, 7);
    const y4 = lauxlib_1.luaL_checknumber(L, 8);
...
function ResetToGameCamera(C, L) {
    const duration = lauxlib_1.luaL_checknumber(L, 1);
...
function PanCameraToWithZ(C, L) {
    const x = lauxlib_1.luaL_checknumber(L, 1);
    const y = lauxlib_1.luaL_checknumber(L, 2);
    const zOffsetDest = lauxlib_1.luaL_checknumber(L, 3);
...
function SetCinematicCamera(C, L) {
    const cameraModelFile = lauxlib_1.luaL_checkstring(L, 1);
...
function SetCameraRotateMode(C, L) {
    const x = lauxlib_1.luaL_checknumber(L, 1);
    const y = lauxlib_1.luaL_checknumber(L, 2);
    const radiansToSweep = lauxlib_1.luaL_checknumber(L, 3);
    const duration = lauxlib_1.luaL_checknumber(L, 4);
...
function SetCameraField(C, L) {
    const whichField = lua_1.lua_touserdata(L, 1);
    const value = lauxlib_1.luaL_checknumber(L, 2);
    const duration = lauxlib_1.luaL_checknumber(L, 3);
...
function SetCameraTargetController(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const xoffset = lauxlib_1.luaL_checknumber(L, 2);
    const yoffset = lauxlib_1.luaL_checknumber(L, 3);
    const inheritOrientation = lua_1.lua_toboolean(L, 4);
...
function CameraSetupSetField(C, L) {
    const whichSetup = lua_1.lua_touserdata(L, 1);
    const whichField = lua_1.lua_touserdata(L, 2);
    const value = lauxlib_1.luaL_checknumber(L, 3);
    const duration = lauxlib_1.luaL_checknumber(L, 4);
...
function CameraSetupApply(C, L) {
    const whichSetup = lua_1.lua_touserdata(L, 1);
    const doPan = lua_1.lua_toboolean(L, 2);
    const panTimed = lua_1.lua_toboolean(L, 3);
...
function CameraSetupApplyWithZ(C, L) {
    const whichSetup = lua_1.lua_touserdata(L, 1);
    const zDestOffset = lauxlib_1.luaL_checknumber(L, 2);
...
function CameraSetupApplyForceDuration(C, L) {
    const whichSetup = lua_1.lua_touserdata(L, 1);
    const doPan = lua_1.lua_toboolean(L, 2);
    const forceDuration = lauxlib_1.luaL_checknumber(L, 3);
...
function CameraSetTargetNoise(C, L) {
    const mag = lauxlib_1.luaL_checknumber(L, 1);
    const velocity = lauxlib_1.luaL_checknumber(L, 2);
...
function CameraSetTargetNoiseEx(C, L) {
    const mag = lauxlib_1.luaL_checknumber(L, 1);
    const velocity = lauxlib_1.luaL_checknumber(L, 2);
    const vertOnly = lua_1.lua_toboolean(L, 3);
...
function CameraSetSmoothingFactor(C, L) {
    const factor = lauxlib_1.luaL_checknumber(L, 1);
...
function SetCineFilterTexture(C, L) {
    const filename = lauxlib_1.luaL_checkstring(L, 1);
...
function SetCineFilterBlendMode(C, L) {
    const whichMode = lua_1.lua_touserdata(L, 1);
...
function SetCineFilterTexMapFlags(C, L) {
    const whichFlags = lua_1.lua_touserdata(L, 1);
...
function SetCineFilterStartUV(C, L) {
    const minu = lauxlib_1.luaL_checknumber(L, 1);
    const minv = lauxlib_1.luaL_checknumber(L, 2);
    const maxu = lauxlib_1.luaL_checknumber(L, 3);
    const maxv = lauxlib_1.luaL_checknumber(L, 4);
...
function SetCineFilterStartColor(C, L) {
    const red = lauxlib_1.luaL_checkinteger(L, 1);
    const green = lauxlib_1.luaL_checkinteger(L, 2);
    const blue = lauxlib_1.luaL_checkinteger(L, 3);
    const alpha = lauxlib_1.luaL_checkinteger(L, 4);
...
function SetCinematicScene(C, L) {
    const portraitUnitId = lauxlib_1.luaL_checkinteger(L, 1);
    const color = lua_1.lua_touserdata(L, 2);
    const speakerTitle = lauxlib_1.luaL_checkstring(L, 3);
    const text = lauxlib_1.luaL_checkstring(L, 4);
    const sceneDuration = lauxlib_1.luaL_checknumber(L, 5);
    const voiceoverDuration = lauxlib_1.luaL_checknumber(L, 6);
...
function GetCameraMargin(C, L) {
    const whichMargin = lauxlib_1.luaL_checkinteger(L, 1);
...
function NewSoundEnvironment(C, L) {
    const environmentName = lauxlib_1.luaL_checkstring(L, 1);
...
function CreateSound(C, L) {
    const fileName = lauxlib_1.luaL_checkstring(L, 1);
    const looping = lua_1.lua_toboolean(L, 2);
    const is3D = lua_1.lua_toboolean(L, 3);
    const stopwhenoutofrange = lua_1.lua_toboolean(L, 4);
    const fadeInRate = lauxlib_1.luaL_checkinteger(L, 5);
    const fadeOutRate = lauxlib_1.luaL_checkinteger(L, 6);
    const eaxSetting = lauxlib_1.luaL_checkstring(L, 7);
...
function CreateSoundFilenameWithLabel(C, L) {
    ...
    const fadeInRate = lauxlib_1.luaL_checkinteger(L, 5);
    const fadeOutRate = lauxlib_1.luaL_checkinteger(L, 6);
    const SLKEntryName = lauxlib_1.luaL_checkstring(L, 7);
...
function CreateSoundFromLabel(C, L) {
    const soundLabel = lauxlib_1.luaL_checkstring(L, 1);
    const looping = lua_1.lua_toboolean(L, 2);
    const is3D = lua_1.lua_toboolean(L, 3);
    const stopwhenoutofrange = lua_1.lua_toboolean(L, 4);
    const fadeInRate = lauxlib_1.luaL_checkinteger(L, 5);
...
function CreateMIDISound(C, L) {
    const soundLabel = lauxlib_1.luaL_checkstring(L, 1);
    const fadeInRate = lauxlib_1.luaL_checkinteger(L, 2);
    const fadeOutRate = lauxlib_1.luaL_checkinteger(L, 3);
...
function SetSoundParamsFromLabel(C, L) {
    const soundHandle = lua_1.lua_touserdata(L, 1);
    const soundLabel = lauxlib_1.luaL_checkstring(L, 2);
...
function SetSoundDistanceCutoff(C, L) {
    const soundHandle = lua_1.lua_touserdata(L, 1);
    const cutoff = lauxlib_1.luaL_checknumber(L, 2);
...
function SetSoundChannel(C, L) {
    const soundHandle = lua_1.lua_touserdata(L, 1);
    const channel = lauxlib_1.luaL_checkinteger(L, 2);
...
function SetSoundVolume(C, L) {
    const soundHandle = lua_1.lua_touserdata(L, 1);
    const volume = lauxlib_1.luaL_checkinteger(L, 2);
...
function SetSoundPitch(C, L) {
    const soundHandle = lua_1.lua_touserdata(L, 1);
    const pitch = lauxlib_1.luaL_checknumber(L, 2);
...
function SetSoundPlayPosition(C, L) {
    const soundHandle = lua_1.lua_touserdata(L, 1);
    const millisecs = lauxlib_1.luaL_checkinteger(L, 2);
...
function SetSoundDistances(C, L) {
    const soundHandle = lua_1.lua_touserdata(L, 1);
    const minDist = lauxlib_1.luaL_checknumber(L, 2);
    const maxDist = lauxlib_1.luaL_checknumber(L, 3);
...
function SetSoundConeAngles(C, L) {
    const soundHandle = lua_1.lua_touserdata(L, 1);
    const inside = lauxlib_1.luaL_checknumber(L, 2);
    const outside = lauxlib_1.luaL_checknumber(L, 3);
    const outsideVolume = lauxlib_1.luaL_checkinteger(L, 4);
...
function StopSound(C, L) {
    const soundHandle = lua_1.lua_touserdata(L, 1);
    const killWhenDone = lua_1.lua_toboolean(L, 2);
    const fadeOut = lua_1.lua_toboolean(L, 3);
...
function SetMapMusic(C, L) {
    const musicName = lauxlib_1.luaL_checkstring(L, 1);
    const random = lua_1.lua_toboolean(L, 2);
    const index = lauxlib_1.luaL_checkinteger(L, 3);
...
function PlayMusicEx(C, L) {
    const musicName = lauxlib_1.luaL_checkstring(L, 1);
    const frommsecs = lauxlib_1.luaL_checkinteger(L, 2);
    const fadeinmsecs = lauxlib_1.luaL_checkinteger(L, 3);
...
function StopMusic(C, L) {
    const fadeOut = lua_1.lua_toboolean(L, 1);
...
function PlayThematicMusic(C, L) {
    const musicFileName = lauxlib_1.luaL_checkstring(L, 1);
...
function SetMusicVolume(C, L) {
    const volume = lauxlib_1.luaL_checkinteger(L, 1);
...
function SetMusicPlayPosition(C, L) {
    const millisecs = lauxlib_1.luaL_checkinteger(L, 1);
...
function SetSoundDuration(C, L) {
    const soundHandle = lua_1.lua_touserdata(L, 1);
    const duration = lauxlib_1.luaL_checkinteger(L, 2);
...
function VolumeGroupSetVolume(C, L) {
    const vgroup = lua_1.lua_touserdata(L, 1);
    const scale = lauxlib_1.luaL_checknumber(L, 2);
...
function RegisterStackedSound(C, L) {
    const soundHandle = lua_1.lua_touserdata(L, 1);
    const byPosition = lua_1.lua_toboolean(L, 2);
    const rectwidth = lauxlib_1.luaL_checknumber(L, 3);
    const rectheight = lauxlib_1.luaL_checknumber(L, 4);
...
function AddWeatherEffect(C, L) {
    const where = lua_1.lua_touserdata(L, 1);
    const effectID = lauxlib_1.luaL_checkinteger(L, 2);
...
function RemoveWeatherEffect(C, L) {
    const whichEffect = lua_1.lua_touserdata(L, 1);
...
function EnableWeatherEffect(C, L) {
    const whichEffect = lua_1.lua_touserdata(L, 1);
    const enable = lua_1.lua_toboolean(L, 2);
...
function TerrainDeformCrater(C, L) {
    ...
    const y = lauxlib_1.luaL_checknumber(L, 2);
    const radius = lauxlib_1.luaL_checknumber(L, 3);
    const depth = lauxlib_1.luaL_checknumber(L, 4);
    const duration = lauxlib_1.luaL_checkinteger(L, 5);
    const permanent = lua_1.lua_toboolean(L, 6);
...
function TerrainDeformRipple(C, L) {
    ...
    const depth = lauxlib_1.luaL_checknumber(L, 4);
    const duration = lauxlib_1.luaL_checkinteger(L, 5);
    const count = lauxlib_1.luaL_checkinteger(L, 6);
    const spaceWaves = lauxlib_1.luaL_checknumber(L, 7);
    const timeWaves = lauxlib_1.luaL_checknumber(L, 8);
    const radiusStartPct = lauxlib_1.luaL_checknumber(L, 9);
    const limitNeg = lua_1.lua_toboolean(L, 10);
...
function TerrainDeformWave(C, L) {
    const x = lauxlib_1.luaL_checknumber(L, 1);
    const y = lauxlib_1.luaL_checknumber(L, 2);
    const dirX = lauxlib_1.luaL_checknumber(L, 3);
    const dirY = lauxlib_1.luaL_checknumber(L, 4);
    const distance = lauxlib_1.luaL_checknumber(L, 5);
    const speed = lauxlib_1.luaL_checknumber(L, 6);
    const radius = lauxlib_1.luaL_checknumber(L, 7);
    const depth = lauxlib_1.luaL_checknumber(L, 8);
    const trailTime = lauxlib_1.luaL_checkinteger(L, 9);
    const count = lauxlib_1.luaL_checkinteger(L, 10);
...
function TerrainDeformRandom(C, L) {
    ...
    const y = lauxlib_1.luaL_checknumber(L, 2);
    const radius = lauxlib_1.luaL_checknumber(L, 3);
    const minDelta = lauxlib_1.luaL_checknumber(L, 4);
    const maxDelta = lauxlib_1.luaL_checknumber(L, 5);
    const duration = lauxlib_1.luaL_checkinteger(L, 6);
    const updateInterval = lauxlib_1.luaL_checkinteger(L, 7);
...
function TerrainDeformStop(C, L) {
    const deformation = lua_1.lua_touserdata(L, 1);
    const duration = lauxlib_1.luaL_checkinteger(L, 2);
...
function AddSpecialEffectLoc(C, L) {
    const modelName = lauxlib_1.luaL_checkstring(L, 1);
    const where = lua_1.lua_touserdata(L, 2);
...
function AddSpecialEffectTarget(C, L) {
    const modelName = lauxlib_1.luaL_checkstring(L, 1);
    const targetWidget = lua_1.lua_touserdata(L, 2);
    const attachPointName = lauxlib_1.luaL_checkstring(L, 3);
...
function AddSpellEffect(C, L) {
    const abilityString = lauxlib_1.luaL_checkstring(L, 1);
    const t = lua_1.lua_touserdata(L, 2);
    const x = lauxlib_1.luaL_checknumber(L, 3);
    const y = lauxlib_1.luaL_checknumber(L, 4);
...
function AddSpellEffectTarget(C, L) {
    ...
    const t = lua_1.lua_touserdata(L, 2);
    const targetWidget = lua_1.lua_touserdata(L, 3);
    const attachPoint = lauxlib_1.luaL_checkstring(L, 4);
...
function AddLightning(C, L) {
    const codeName = lauxlib_1.luaL_checkstring(L, 1);
    const checkVisibility = lua_1.lua_toboolean(L, 2);
    const x1 = lauxlib_1.luaL_checknumber(L, 3);
    const y1 = lauxlib_1.luaL_checknumber(L, 4);
    const x2 = lauxlib_1.luaL_checknumber(L, 5);
    const y2 = lauxlib_1.luaL_checknumber(L, 6);
...
function AddLightningEx(C, L) {
    ...
    const x1 = lauxlib_1.luaL_checknumber(L, 3);
    const y1 = lauxlib_1.luaL_checknumber(L, 4);
    const z1 = lauxlib_1.luaL_checknumber(L, 5);
    const x2 = lauxlib_1.luaL_checknumber(L, 6);
    const y2 = lauxlib_1.luaL_checknumber(L, 7);
    const z2 = lauxlib_1.luaL_checknumber(L, 8);
...
function DestroyLightning(C, L) {
    const whichBolt = lua_1.lua_touserdata(L, 1);
...
function SetLightningColor(C, L) {
    const whichBolt = lua_1.lua_touserdata(L, 1);
    const r = lauxlib_1.luaL_checknumber(L, 2);
    const g = lauxlib_1.luaL_checknumber(L, 3);
    const b = lauxlib_1.luaL_checknumber(L, 4);
    const a = lauxlib_1.luaL_checknumber(L, 5);
...
function SetWaterDeforms(C, L) {
    const val = lua_1.lua_toboolean(L, 1);
...
function SetTerrainType(C, L) {
    const x = lauxlib_1.luaL_checknumber(L, 1);
    const y = lauxlib_1.luaL_checknumber(L, 2);
    const terrainType = lauxlib_1.luaL_checkinteger(L, 3);
    const variation = lauxlib_1.luaL_checkinteger(L, 4);
    const area = lauxlib_1.luaL_checkinteger(L, 5);
    const shape = lauxlib_1.luaL_checkinteger(L, 6);
...
function IsTerrainPathable(C, L) {
    const x = lauxlib_1.luaL_checknumber(L, 1);
    const y = lauxlib_1.luaL_checknumber(L, 2);
    const t = lua_1.lua_touserdata(L, 3);
...
function SetTerrainPathable(C, L) {
    ...
    const y = lauxlib_1.luaL_checknumber(L, 2);
    const t = lua_1.lua_touserdata(L, 3);
    const flag = lua_1.lua_toboolean(L, 4);
...
function CreateImage(C, L) {
    const file = lauxlib_1.luaL_checkstring(L, 1);
    const sizeX = lauxlib_1.luaL_checknumber(L, 2);
    const sizeY = lauxlib_1.luaL_checknumber(L, 3);
    const sizeZ = lauxlib_1.luaL_checknumber(L, 4);
    const posX = lauxlib_1.luaL_checknumber(L, 5);
    const posY = lauxlib_1.luaL_checknumber(L, 6);
    const posZ = lauxlib_1.luaL_checknumber(L, 7);
    const originX = lauxlib_1.luaL_checknumber(L, 8);
    const originY = lauxlib_1.luaL_checknumber(L, 9);
    const originZ = lauxlib_1.luaL_checknumber(L, 10);
    const imageType = lauxlib_1.luaL_checkinteger(L, 11);
...
function DestroyImage(C, L) {
    const whichImage = lua_1.lua_touserdata(L, 1);
...
function SetImageAboveWater(C, L) {
    const whichImage = lua_1.lua_touserdata(L, 1);
    const flag = lua_1.lua_toboolean(L, 2);
    const useWaterAlpha = lua_1.lua_toboolean(L, 3);
...
function SetImageType(C, L) {
    const whichImage = lua_1.lua_touserdata(L, 1);
    const imageType = lauxlib_1.luaL_checkinteger(L, 2);
...
function CreateUbersplat(C, L) {
    const x = lauxlib_1.luaL_checknumber(L, 1);
    const y = lauxlib_1.luaL_checknumber(L, 2);
    const name = lauxlib_1.luaL_checkstring(L, 3);
    const red = lauxlib_1.luaL_checkinteger(L, 4);
    const green = lauxlib_1.luaL_checkinteger(L, 5);
    const blue = lauxlib_1.luaL_checkinteger(L, 6);
    const alpha = lauxlib_1.luaL_checkinteger(L, 7);
    const forcePaused = lua_1.lua_toboolean(L, 8);
    const noBirthTime = lua_1.lua_toboolean(L, 9);
...
function DestroyUbersplat(C, L) {
    const whichSplat = lua_1.lua_touserdata(L, 1);
...
function SetBlight(C, L) {
    ...
    const y = lauxlib_1.luaL_checknumber(L, 3);
    const radius = lauxlib_1.luaL_checknumber(L, 4);
    const addBlight = lua_1.lua_toboolean(L, 5);
...
function SetBlightRect(C, L) {
    const whichPlayer = lua_1.lua_touserdata(L, 1);
    const r = lua_1.lua_touserdata(L, 2);
    const addBlight = lua_1.lua_toboolean(L, 3);
...
function SetBlightPoint(C, L) {
    ...
    const x = lauxlib_1.luaL_checknumber(L, 2);
    const y = lauxlib_1.luaL_checknumber(L, 3);
    const addBlight = lua_1.lua_toboolean(L, 4);
...
function SetDoodadAnimation(C, L) {
    ...
    const y = lauxlib_1.luaL_checknumber(L, 2);
    const radius = lauxlib_1.luaL_checknumber(L, 3);
    const doodadID = lauxlib_1.luaL_checkinteger(L, 4);
    const nearestOnly = lua_1.lua_toboolean(L, 5);
    const animName = lauxlib_1.luaL_checkstring(L, 6);
    const animRandom = lua_1.lua_toboolean(L, 7);
...
function SetDoodadAnimationRect(C, L) {
    const r = lua_1.lua_touserdata(L, 1);
    const doodadID = lauxlib_1.luaL_checkinteger(L, 2);
    const animName = lauxlib_1.luaL_checkstring(L, 3);
    const animRandom = lua_1.lua_toboolean(L, 4);
...
function StartMeleeAI(C, L) {
    const num = lua_1.lua_touserdata(L, 1);
    const script = lauxlib_1.luaL_checkstring(L, 2);
...
function CommandAI(C, L) {
    const num = lua_1.lua_touserdata(L, 1);
    const command = lauxlib_1.luaL_checkinteger(L, 2);
    const data = lauxlib_1.luaL_checkinteger(L, 3);
...
function PauseCompAI(C, L) {
    const p = lua_1.lua_touserdata(L, 1);
    const pause = lua_1.lua_toboolean(L, 2);
...
function RemoveGuardPosition(C, L) {
    const hUnit = lua_1.lua_touserdata(L, 1);
 ...
 */
function Cheat(C, L) {
    const cheatStr = lauxlib_1.luaL_checkstring(L, 1);
...
function AutomationTestStart(C, L) {
    const testName = lauxlib_1.luaL_checkstring(L, 1);
...
function BlzSetAbilityTooltip(C, L) {
    const abilCode = lauxlib_1.luaL_checkinteger(L, 1);
    const tooltip = lauxlib_1.luaL_checkstring(L, 2);
    const level = lauxlib_1.luaL_checkinteger(L, 3);
...
function BlzSetAbilityExtendedTooltip(C, L) {
    const abilCode = lauxlib_1.luaL_checkinteger(L, 1);
    const ExtendedTooltip = lauxlib_1.luaL_checkstring(L, 2);
    const level = lauxlib_1.luaL_checkinteger(L, 3);
...
function BlzSetAbilityResearchTooltip(C, L) {
    const abilCode = lauxlib_1.luaL_checkinteger(L, 1);
    const researchTooltip = lauxlib_1.luaL_checkstring(L, 2);
    const level = lauxlib_1.luaL_checkinteger(L, 3);
...
function BlzSetAbilityResearchExtendedTooltip(C, L) {
    const abilCode = lauxlib_1.luaL_checkinteger(L, 1);
    const researchExtendedTooltip = lauxlib_1.luaL_checkstring(L, 2);
    const level = lauxlib_1.luaL_checkinteger(L, 3);
...
function BlzSetAbilityPosX(C, L) {
    const abilCode = lauxlib_1.luaL_checkinteger(L, 1);
    const x = lauxlib_1.luaL_checkinteger(L, 2);
...
function BlzSetAbilityPosY(C, L) {
    const abilCode = lauxlib_1.luaL_checkinteger(L, 1);
    const y = lauxlib_1.luaL_checkinteger(L, 2);
...
function BlzSetUnitMaxHP(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const hp = lauxlib_1.luaL_checkinteger(L, 2);
...
function BlzSetUnitMaxMana(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const mana = lauxlib_1.luaL_checkinteger(L, 2);
...
function BlzGetUnitBaseDamage(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const weaponIndex = lauxlib_1.luaL_checkinteger(L, 2);
...
function BlzSetUnitBaseDamage(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const baseDamage = lauxlib_1.luaL_checkinteger(L, 2);
    const weaponIndex = lauxlib_1.luaL_checkinteger(L, 3);
...
function BlzSetUnitDiceNumber(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const diceNumber = lauxlib_1.luaL_checkinteger(L, 2);
    const weaponIndex = lauxlib_1.luaL_checkinteger(L, 3);
...
function BlzSetUnitDiceSides(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const diceSides = lauxlib_1.luaL_checkinteger(L, 2);
    const weaponIndex = lauxlib_1.luaL_checkinteger(L, 3);
...
function BlzSetUnitAttackCooldown(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const cooldown = lauxlib_1.luaL_checknumber(L, 2);
    const weaponIndex = lauxlib_1.luaL_checkinteger(L, 3);
...
function BlzSetSpecialEffectColor(C, L) {
    const whichEffect = lua_1.lua_touserdata(L, 1);
    const r = lauxlib_1.luaL_checkinteger(L, 2);
    const g = lauxlib_1.luaL_checkinteger(L, 3);
    const b = lauxlib_1.luaL_checkinteger(L, 4);
...
function BlzSetSpecialEffectAlpha(C, L) {
    const whichEffect = lua_1.lua_touserdata(L, 1);
    const alpha = lauxlib_1.luaL_checkinteger(L, 2);
...
function BlzSetSpecialEffectTime(C, L) {
    const whichEffect = lua_1.lua_touserdata(L, 1);
    const time = lauxlib_1.luaL_checknumber(L, 2);
...
function BlzSetSpecialEffectOrientation(C, L) {
    const whichEffect = lua_1.lua_touserdata(L, 1);
    const yaw = lauxlib_1.luaL_checknumber(L, 2);
    const pitch = lauxlib_1.luaL_checknumber(L, 3);
    const roll = lauxlib_1.luaL_checknumber(L, 4);
...
function BlzSetSpecialEffectRoll(C, L) {
    const whichEffect = lua_1.lua_touserdata(L, 1);
    const roll = lauxlib_1.luaL_checknumber(L, 2);
...
function BlzSetSpecialEffectZ(C, L) {
    const whichEffect = lua_1.lua_touserdata(L, 1);
    const z = lauxlib_1.luaL_checknumber(L, 2);
...
function BlzSetUnitArmor(C, L) {
    const whichUnit = lua_1.lua_touserdata(L, 1);
    const armorAmount = lauxlib_1.luaL_checknumber(L, 2);
...
function BlzUnitDisableAbility(C, L) {
    ...
    const abilId = lauxlib_1.luaL_checkinteger(L, 2);
    const flag = lua_1.lua_toboolean(L, 3);
    const hideUI = lua_1.lua_toboolean(L, 4);
...
function BlzGetAbilityManaCost(C, L) {
    const abilId = lauxlib_1.luaL_checkinteger(L, 1);
    const level = lauxlib_1.luaL_checkinteger(L, 2);
...
function BlzSetUnitAbilityCooldown(C, L) {
    ...
    const abilId = lauxlib_1.luaL_checkinteger(L, 2);
    const level = lauxlib_1.luaL_checkinteger(L, 3);
    const cooldown = lauxlib_1.luaL_checknumber(L, 4);
...
function BlzSetUnitAbilityManaCost(C, L) {
    ...
    const abilId = lauxlib_1.luaL_checkinteger(L, 2);
    const level = lauxlib_1.luaL_checkinteger(L, 3);
    const manaCost = lauxlib_1.luaL_checkinteger(L, 4);
...
function BlzSetEventDamage(C, L) {
    const damage = lauxlib_1.luaL_checknumber(L, 1);
...
function bindNatives(C) {
    ...
    lua_1.lua_register(L, 'ConvertAnimType', ConvertAnimType.bind(null, C));
    lua_1.lua_register(L, 'ConvertSubAnimType', ConvertSubAnimType.bind(null, C));
